...
#define __RTC_HW_PWOFF__
	...
	#ifdef __OTP_4BIT__
		#ifdef __Security__
			#define DATE_CODE   "20170313 4-Bit Mode with Security"
		#else
			#define DATE_CODE   "20170313 4-Bit Mode"
		#endif
	#else
		#ifdef __Security__
			#define DATE_CODE   "20170313 with Security"	
		#else			
			#define DATE_CODE   "20170313"
		#endif			
	#endif
